...
//////////////////////////////////////////////
/** \brief Funcion que permite contar segun la funcion que recibe como parametro.
 *
 * \param void*LinkedList Lista a recorrer para contar.
 * \param pFunc Puntero a la funcion que establece el criterio para contar.
 * \return int Retorna la cantidad contada  o -1 si hubo error.
 *
 */
...
/** \brief Funcion que filtra una lista y retorna el puntero a una nueva lista filtrada.
 *
 * \param LinkedList* Puntero de la lista original a filtrar.
  * \param pFunc Puntero a la funcion que establece el critrio de filtrado.
 * \return Retorna el puntero a la lista creada o NULL si hubo error.
 *
 */
 ...
 * \param LinkedList* Puntero de la lista original a filtrar.
  * \param pFunc Puntero a la funcion que establece el critrio de filtrado.
  *\param char* cadena que se le pasa a la funcion criterio para buscar por ese valor.
 * \return Retorna el puntero a la lista creada o NULL si hubo error.
 *
 */
LinkedList* ll_filterPorCadenaCaracter(LinkedList* this,int (*pFunc)(void*,char*),char* cadena){
    LinkedList* pLinkedList = NULL;
    int longitud;
    int i;
    void* pElement;
    ...
    if(pLinkedList != NULL){
        ...
        for(i=0; i < longitud ;i++){
            pElement = ll_get(this,i);
            if(pElement != NULL && pFunc(pElement,cadena) == 1){
                ll_add(pLinkedList,pElement);
            }
        }
    }
...
LinkedList* ll_filterPorEntero(LinkedList* this,int (*pFunc)(void*,int*),int* entero){
    LinkedList* pLinkedList = NULL;
    int longitud;
    int i;
    void* pElement;
    ...
    if(pLinkedList != NULL){
        ...
        for(i=0; i < longitud ;i++){
            pElement = ll_get(this,i);
            if(pElement != NULL && pFunc(pElement,entero) == 1){
                ll_add(pLinkedList,pElement);
            }
        }
    }
...
/** \brief Funcion que crea una nueva lista filtrada.
 *
 * \param LinkedList Puntero a la lista original para filtrar.
  * \param pFunc Puntero a la funcion que determina el criterio.
 * \return Puntero a la lista filtrada o NULL si hubo error.
 *
 */
